...
export default function Home() {
  ...
  return <main>
    <nav className="nav wrap"><a href="#top" className="brand"><img src="/logo.png" alt="AIwithBishal" /></a><div className="nav-links"><a href="#services">Services</a><a href="#process">Process</a><a href="#contact">Contact</a></div><button className="nav-cta" onClick={scrollToContact}><span className="nav-label-full">Book a strategy call</span><span className="nav-label-short">Book a call</span><b>↗</b></button></nav>
    ...
    <section id="contact" className="contact"><div className="wrap contact-box flodesk-contact-box"><div className="contact-copy"><p className="eyebrow dark"><i /> START THE CONVERSATION</p><h2>Ready to grow<br/><em>with intention?</em></h2><p>Tell us where you want to go. Complete the form and I&apos;ll contact you personally to arrange your one-to-one consultation.</p><a className="contact-email" href="mailto:hello@aiwithbishal.com">hello@aiwithbishal.com <b>↗</b></a></div><FlodeskForm /></div></section>
